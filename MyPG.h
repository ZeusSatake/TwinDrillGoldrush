...
//	カメラの設定
	...
	public:
		...
		ML::Vec2 screenCenterPos;//画面中央の座標
		...
		//上下左右の順
		float angleTable[4] = { 90.0f, 270.0f, 180.0f, 0.0f };
		...
		DG::Image::SP FontImage;
		ML::Point FontImageSize{ 24, 32 };
		void DrawNumFont(int value, ML::Vec2 drawPos, ML::Point size);
		void DrawNumFont(int value, const FontImageInfo& imgInfo_, ML::Vec2 drawPos, ML::Point drawSize_);
		int score;
		//上位スコア 0 > 1 > 2
		int topScores[3];
		int gameScreenWidth;
